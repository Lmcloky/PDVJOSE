...
class ModeloTranslados{

	/*==============================================================================
	=                               MOSTRAR LAS VENTAS                             =
	==============================================================================*/

	static public function mdlMostrarTranslados($tabla, $item, $valor){
		...
		static public function mdlIngresarTranslado($tabla, $datos){
	...
	static public function mdlBorrarTranslado($tabla, $datos){
	...
	static public function mdlRangoFechasTranslados($tabla, $fechaInicial, $fechaFinal){
