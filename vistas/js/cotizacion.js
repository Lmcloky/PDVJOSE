...
if (localStorage.getItem("capturarRango3") != null) {
	...
	$("#daterange-btn3 sapn").html('<i class="fa fa-calendar"></i> Rango de Fecha')
...
function quitarAgregarProducto(){
	...
	var botonesTabla = $(".tablaCotizaciones tbody button.agregarProducto");
...
$('#daterange-btn3').daterangepicker(
  ...
  function (start, end) {
    ...
    var capturarRango3 = $("#daterange-btn3 span").html();   
   	...
   	window.location = "index.php?ruta=cotizaciones&fechaInicial="+fechaInicial+"&fechaFinal="+fechaFinal+" 23:59:59";

  }
)

$(".daterangepicker.opensleft1 .range_inputs .cancelBtn").on("click", function(){
...
$(".daterangepicker.opensleft1 .ranges li").on("click", function(){
