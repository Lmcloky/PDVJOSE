              ...
              <div class="box-body">
                ...
                <div class="box">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-key"></i> </span>
                        ...
                        <?php 
                          ...
                          $entradas = ControladorEntradas::ctrMostrarEntradas($item, $valor, $orden);

                          if (!$entradas) {
                            
                            echo '<input type="text" class="form-control" id="nuevaEntrada" name="nuevaEntrada" value="100001" readonly>';
                  ...
                  <div class="form-group row nuevoProducto"> 
                    ...
                    <input type="hidden" id="elistaProductos" name="elistaProductos">
